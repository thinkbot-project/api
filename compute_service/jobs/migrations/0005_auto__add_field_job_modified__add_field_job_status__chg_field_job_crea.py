...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'jobs_job', 'modified',
                      self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'Job.status'
        db.add_column(u'jobs_job', 'status',
                      self.gf('model_utils.fields.StatusField')(default='submitted', max_length=100, no_check_for_status=True),
                      keep_default=False)


        # Changing field 'Job.created'
        db.alter_column(u'jobs_job', 'created', self.gf('model_utils.fields.AutoCreatedField')())
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'jobs_job', 'status')
    ...
    models = {
        ...
        u'jobs.job': {
            ...
            'output': ('django.db.models.fields.CharField', [], {'default': "'stdout'", 'max_length': '50'}),
